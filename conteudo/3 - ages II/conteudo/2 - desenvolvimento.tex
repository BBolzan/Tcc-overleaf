...
\begin{figure}[H]
    ...
    Fonte: \url{https://tools.ages.pucrs.br/planline/wiki/-/wikis/banco_dados}
...
\begin{figure}[H]
    ...
    \includegraphics[width=1\linewidth]{conteudo//3 - ages II//conteudo//figures/arquitetura-diagrama-de-deploy-ages2.png}
    Fonte: \url{https://tools.ages.pucrs.br/planline/wiki/-/wikis/arquitetura}
    \label{fig:banco-de-dados-esquema-conceitual-ages2}
\end{figure}

\indent Para a nossa infraestrutura, nós utilizamos duas instâncias da AWS \cite{aws}. Configuramos o Gitlab \cite{gitlab} Runner para que, a cada nova contribuição (como um commit ou merge), ele carregue os códigos dos repositórios do Frontend Web e do Backend e os armazene dentro de seus respectivos containers Docker \cite{docker}.
...
\begin{itemize}
    ...
    \item \textbf{Tailwind CSS} \cite{tailwind}: Para a estilização da aplicação web, utilizamos o Tailwind CSS \cite{tailwind}, uma estrutura que nos permitiu criar interfaces modernas e responsivas de forma ágil.
