...
\begin{figure}[H]
    ...
    Fonte: \url{https://tools.ages.pucrs.br/saude-bucal-quilombola/wiki/-/wikis/banco%20de%20dados}
...
\begin{itemize}
    ...
    \item \textbf{Styles}: Onde definimos os estilos globais e temas com o Tailwind CSS \cite{css} \cite{tailwind}.
...
\begin{figure}[H]
    ...
    Fonte: \url{https://tools.ages.pucrs.br/saude-bucal-quilombola/wiki/-/wikis/infraestrutura}
...
\indent Para o nosso backend, nós escolhemos a linguagem Node.js \cite{nodejs} com o framework NestJS \cite{nestjs}. Para facilitar o desenvolvimento e a interação com o banco de dados, utilizamos o Prisma \cite{prisma} como ORM e o PostgreSQL \cite{postgresql} como nosso sistema de banco de dados. Adotamos também o Swagger \cite{swagger} para documentar nossas rotas e o Docker \cite{docker} para a containerização da aplicação.
...
\begin{itemize}
    ...
    \item \textbf{Tailwind CSS} \cite{tailwind}: Estrutura de design que adotamos para estilizar nossa aplicação web de forma ágil com classes CSS \cite{css} utilitárias.
