...
\begin{itemize}
    ...
    \item \textbf{Tailwind CSS} \cite{tailwind}: Para a estilização da aplicação web, utilizamos o Tailwind CSS \cite{css}, uma estrutura que nos permitiu criar interfaces modernas e responsivas de forma ágil.
