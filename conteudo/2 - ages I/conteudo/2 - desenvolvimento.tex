...
\subsection{Tecnologias Utilizadas}
    Para o desenvolvimento do backend, nós escolhemos a linguagem Node.js em conjunto com o framework Nest.js, principalmente por sua documentação ser bastante abrangente e didática. Adicionalmente, utilizamos o Prisma, um \ac{orm}, como ferramenta para simplificar nossa interação com o banco de dados.    No frontend, desenvolvemos a aplicação com a linguagem TypeScript e o framework React para a criação das interfaces e dos componentes visuais. A relação completa das tecnologias que empregamos no projeto está ilustrada na Figura 6.
