\subsection{Sprint 0}
\indent Em agosto, iniciamos o Projeto Planline, que marcou o começo da minha jornada como AGES II. Para esta nova fase, meu objetivo pessoal era me aprofundar em desenvolvimento mobile com React Native, uma área que eu não tive a oportunidade de explorar no projeto anterior. Para acelerar meu aprendizado, comecei a desenvolver um projeto pessoal paralelo: uma calculadora de IMC para dispositivos móveis.
