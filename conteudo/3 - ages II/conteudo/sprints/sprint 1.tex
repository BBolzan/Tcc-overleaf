...
\indent O desenvolvimento dessas telas representou um desafio técnico para mim, pois eu ainda não estava familiarizado com o uso do Tailwind CSS \cite{css}. Para superar essa barreira, precisei primeiro aprofundar meus conhecimentos nos fundamentos do CSS \cite{css} nativo para, em seguida, conseguir aplicar e adaptar esses conceitos ao framework Tailwind. Foi uma importante curva de aprendizado.
